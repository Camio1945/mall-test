...
/** 商品分类管理Service实现类 Created by macro on 2018/4/26. */
@Service
public class PmsProductCategoryServiceImpl implements PmsProductCategoryService {
  ...
  @Autowired private PmsProductCategoryAttributeRelationDao productCategoryAttributeRelationDao;

  @Autowired
  private PmsProductCategoryAttributeRelationMapper productCategoryAttributeRelationMapper;

  @Autowired private PmsProductCategoryDao productCategoryDao;
  ...
  private void setCategoryLevel(PmsProductCategory productCategory) {
    ...
    if (productCategory.getParentId() == 0) {
      ...
      // 有父分类时选择根据父分类level设置
      PmsProductCategory parentCategory =
